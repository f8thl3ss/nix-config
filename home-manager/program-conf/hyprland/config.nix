  ...
  wayland.windowManager.hyprland = {
    settings = {
      ...
      exec-once = [
        ...
        "blueman-applet &"
        "swww-daemon &"
        "sleep 1 && swww img ~/Pictures/wallpapers/city_night_tokio_style.jpg"
      ...
      animations = {
        ...
        animation = [
          ...
          "workspaces, 1, 4, default, slide" # styles: slide, slidevert, fade, slidefade, slidefadevert
        ];
      };
    ...
    extraConfig = "
      ...
      monitor=DP-3,2560x1440@74.97,0x0,1
